              ...
              <CardContent>
                {bookingConfig.cal.username.trim() !== '' ? (
                  <BookingIntegration
                    service="cal"
                    calUsername={bookingConfig.cal.username}
                    calEventSlug={services.find(s => s.id === selectedService)?.eventSlug}
                    inline={true}
                    primaryColor="#9333ea"
